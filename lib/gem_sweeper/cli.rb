  ...
  class CLI
    ...
    def run_init(argv)
      ...
      OptionParser.new do |parser|
        parser.banner = "Usage: gem-sweeper init [--force]"
    ...
    def parse_scan_options(argv)
      ...
      OptionParser.new do |parser|
        parser.banner = "Usage: gem-sweeper scan [options]"
    ...
    def parse_clean_options(argv)
      ...
      OptionParser.new do |parser|
        parser.banner = "Usage: gem-sweeper clean [options]"
        common_options(parser, options)
    ...
    def parse_pr_options(argv)
      ...
      OptionParser.new do |parser|
        parser.banner = "Usage: gem-sweeper pr [options]"
        common_options(parser, options)
    ...
    def common_options(parser, options)
      ...
      parser.on("--config PATH", "path to .gem-sweeper.yml") { |value| options[:config_path] = value }
    ...
    def help_text
      <<~TEXT
        ...
        Commands:
          ...
          init     Generate .gem-sweeper.yml
          version  Print gem-sweeper version
      TEXT
    end
  end
end
